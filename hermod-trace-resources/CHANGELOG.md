# Revision history for hermod-trace-resources

## 0.2.4
* Moved from cardano-node to hermod-tracing; renamed package to hermod-trace-resources
* Module namespace changed from Cardano.Logging.Resources to Hermod.Tracing.Resources
