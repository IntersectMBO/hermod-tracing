...
--   (triggered by a 'Hermod.Tracing.Types.TCDocument' control message) and
--   read back by tooling to produce human-readable documentation of a live
--   tracer configuration.
--
--   'ConfigReflection' is filled by the 'Hermod.Tracing.Types.TCOptimize'
...
import           Hermod.Tracing.Types.Annotations (DetailLevel, Privacy,
                   SeverityF, SeverityS)
